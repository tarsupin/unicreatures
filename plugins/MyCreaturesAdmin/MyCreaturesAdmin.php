...
/****** Create a new Area Type ******/
	...
	(
		$type				// <str> The type of area (lowercase name, like "meadow", and "pond").
	,	$upgradesFrom = ""	// <str> The type of area that it upgrades from (e.g. "pond")
	,	$maxPop = 50		// <int> The maximum allowed population in the area.
	,	$maxAllowed = 0		// <int> The number of these types of areas you can own. 0 for infinite.
...
/****** Create a new Creature Type ******/
	...
	(
		$typeID			// <int> The creature type ID of the creature to send to.
	,	$rarity			// <int> The rarity of the pet (0 common, 2 uncommon, 6 rare, 9 legendary, etc).
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Create a new Creature Type ******/
	...
	(
		$family				// <str> The name of the creature's family.
	,	$name				// <str> The name of the creature.
	,	$prefix				// <str> The prefix of the creature (a color, noble, exalted, etc).
	,	$blurb				// <str> The mini-description / blurb (140 characters) of the creature.
	,	$description		// <str> The full description of the creature.
	,	$requiredPoints		// <int> The number of points required to evolve to this pet.
	,	$evolvesFrom = 0	// <int> The creature type ID that this pet can evolve from.
