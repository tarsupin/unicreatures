...
/****** Get Achievement Score for a user ******/
	...
	(
		$uniID		// <int> The UniID to get the achievements score for.
	)				// RETURNS <int> the achievement score of the user.
...
/****** Get Achievement List ******/
	...
	(
		$uniID		// <int> The UniID to get achievements for.
	)				// RETURNS <int:[str:mixed]> the list of achievements of the user, or empty array on failure.
...
/****** Set Achievement ******/
	...
	(
		$uniID				// <int> The UniID to add the achievement to.
	,	$creatureFamily		// <str> The creature family to add the achievement for.
	,	$type				// <str> The type of achievement being updated.
	,	$value				// <mixed> The value associated with the update that we need to interpret.
