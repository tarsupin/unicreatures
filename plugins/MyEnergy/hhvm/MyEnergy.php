...
/****** Create the User's Row for the Energy Table ******/
	...
	(
		int $uniID		// <int> The UniID to add to the energy table.
	): bool				// RETURNS <bool>
...
/****** Get Energy ******/
	...
	(
		int $uniID			// <int> The Uni-Account to identify the amount of energy from.
	): int					// RETURNS <int> amount of energy currently available, or 0 on failure.
...
/****** Change Energy ******/
	...
	(
		int $uniID			// <int> The Uni-Account to set energy for.
	,	int $energy			// <int> The energy amount to add (or subtract, if negative).
	): mixed					// RETURNS <mixed> amount of energy currently available, or FALSE on error.
...
/****** Set Energy ******/
	...
	(
		int $uniID			// <int> The Uni-Account to set energy for.
	,	int $energy			// <int> The energy amount to set the user at.
	): int					// RETURNS <int> amount of energy currently available.
