...
/****** Plugin Variables ******/
	public static int $dayCount = 0;		// <int> The number of times the user has been visited today.
	
	
/****** Log a user, or identify them as being already logged ******/
	public static function userTracker
	(
		int $uniID				// <int> The UniID to check if an IP has been triggered.
	,	int $timelimit = 86400	// <int> The duration (in seconds) to disregard old visits.
	): bool						// RETURNS <bool> TRUE if the user was newly logged, FALSE if already tracked.
...
/****** Checks how many ip logs are with a user ******/
	...
	(
		int $uniID				// <int> The UniID to check IP logs for.
	): bool						// RETURNS <bool> TRUE if the user was newly logged, FALSE if already tracked.
...
/****** Clean up old IP logs for a user's visits ******/
	...
	(
		int $uniID				// <int> The UniID of the user to clean IP logs.
	,	int $timelimit = 86400	// <int> The duration (in seconds) to retain IP logs.
