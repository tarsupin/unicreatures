...
/****** Get random encounter from a zone ******/
	...
	(
		$zone			// <str> The zone that you're traversing for an encounter.
	)					// RETURNS <str:mixed> data for the encounter that you got.
...
/****** Retrieve a list of areas ******/
	...
	(
		$achievements = 99999	// <int> The number of achievements the user possesses.
	)							// RETURNS <str:[str:mixed]> the list of exploration zones visible to user.
