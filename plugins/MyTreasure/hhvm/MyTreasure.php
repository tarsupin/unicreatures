...
/****** Class Variables ******/
	public static string $exploreZone = "";		// <str> The current zone being explored.
...
/****** Retrieve treasures from an area ******/
	...
	(
		int $uniID			// <int> The Uni-Account receiving the treasure.
	): string					// RETURNS <str> the type of treasure to return, or "" on nothing.
...
/****** Get a random egg rarity (exploration or hut) ******/
	...
	): int					// RETURNS <int> random rarity for an egg based on probability.
...
/****** Get a random exploration creature, based on a rarity provided ******/
	...
	(
		int $rarity		// <int> The rarity of the exploration creature to retrieve.
	): int				// RETURNS <int> the type ID of the creature to provide, or 0 if none.
...
/****** Open a mystery box ******/
	...
	(
		int $uniID		// <int> The ID of the user opening the box.
	): array <str, mixed>				// RETURNS <str:mixed> data on the content.
...
/****** Update a user to receive treasure ******/
	...
	(
		int $uniID			// <int> The UniID receiving the treasure.
	,	string $treasure = ""	// <str> The treasure to provide the user.
	, 	int $count = 1		// <int> The number of the treasure to acquire.
	): array					// RETURNS <array> data regarding the treasure that was received, or links to retrieve it.
...
/****** Update a user to receive treasure in bulk ******/
	...
	(
		int $uniID			// <int> The UniID receiving the treasure.
	,	array $treasures		// <array> List of treasures to provide the user.
	): bool					// RETURNS <bool> TRUE if the user received the update.
...
/****** Return Treasure Data ******/
	...
	(
		string $treasure		// <str> Type of treasure to return data on.
	): array <str, mixed>					// RETURNS <str:mixed> data on the treasure (image, name, etc).
...
/****** Return contents of the treasure queue ******/
	...
	(
		int $uniID			// <int> The UniID to retrieve the treasure queue of.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> list of queued treasuers for that user, FALSE on failure.
...
/****** Retrieve an item from the treasure queue ******/
	...
	(
		int $uniID			// <int> The UniID to retrieve the treasure queue of.
	,	int $dateEnds		// <int> The date that the treasure is disappearing (identifies which one to select).
	): bool					// RETURNS <bool> TRUE if you retrieved the item, FALSE on failure.
...
/****** Add entry to the treasure queue ******/
	...
	(
		int $uniID			// <int> The UniID that you're adding the queue for.
	,	string $treasure		// <str> The treasure to add to the queue.
	,	array $parameters		// <array> The parameters to add to the treasure.
	,	int $duration		// <int> The duration (in seconds) to keep the item in the queue.
...
/****** Removes contents of the treasure queue ******/
	...
	(
		int $uniID			// <int> The UniID to delete a treasure queue entry.
	,	int $dateEnds		// <int> The date that the treasure is disappearing (identifies which one to delete).
	): bool					// RETURNS <bool> TRUE if deleted, FALSE on failure.
