...
/****** Get the creatures for sale in the shop ******/
	...
	)					// RETURNS <int:[str:mixed]> the list of creatures available in the shop, or FALSE on failure.
...
/****** Get pet data on a shop pet ******/
	...
	(
		$shopBuyID		// <int> The purchase ID for the shop pet.
	)					// RETURNS <str:mixed> the data of the new creature, or array() on failure.
