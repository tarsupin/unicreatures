...
/****** Get data about a team ******/
	...
	(
		$teamID			// <int> The team that you're sending the creature to.
	)					// RETURNS <str:mixed> the ID of the new creature, or array() on failure.
...
/****** Create a new team ******/
	...
	(
		$uniID			// <int> The UniID creating the team.
	,	$creatureID		// <int> The creature ID that you're creating the team with.
	,	$teamName		// <str> The name of the team to create.
	)					// RETURNS <int> the ID of the new team, or 0 on failure.
...
/****** Get the team list (and data) rom a user ******/
	...
	(
		$uniID		// <int> The UniID to get teams and data from.
	)				// RETURNS <int:[str:mixed]> the list of team and their data.
...
/****** Get a list of team IDs from a user ******/
	...
	(
		$uniID			// <int> The UniID to get teams from.
	)					// RETURNS <int:int> the list of team ID's that belong to the user.
...
/****** Send a creature to a team ******/
	...
	(
		$creatureID		// <int> The creature to send a team to.
	,	$teamID			// <int> The team that you're sending the creature to.
...
/****** Send a creature from the team to the wild area ******/
	...
	(
		$uniID			// <int> The UniID to handle the teaming with.
	,	$teamID			// <int> The team that you're sending the creature to.
	,	$typeID			// <int> The creature type ID to return.
	,	$nickname		// <str> The nickname of the pet to return.
	)					// RETURNS <bool> TRUE on success, or FALSE on failure.
...
/****** Get the list of pets from a team ******/
	...
	(
		$teamID		// <int> The Herd ID to get creatures from.
	)				// RETURNS <int:[str:mixed]> the array of creatures in the team.
