...
/****** Get a new Creature ******/
	...
	,	$typeID				// <int> The type of the creature that you're receiving.
	,	$forceGender = ""	// <str> The character of gender, if you want to force it.
	,	$forceNickname = ""	// <str> The nickname of the creature, if you want to force it.
	,	$forceEXP = 0		// <int> The EXP to enforce, if desired.
	,	$forcePoints = 0	// <int> The points to enforce, if desired.
	)						// RETURNS <int> the ID of the new creature, or 0 on failure.
...
/****** Change the Pet Type (Evolve, Reverse-Evolve, Nobilize, etc) ******/
	...
	,	$newTypeID		// <int> The ID of the new creature type to set your evolution to.
...
/****** Delete a Creature ******/
	...
	(
		$creatureID		// <int> The creature to delete.
...
/****** Get the Type ID of the creature ******/
	...
	(
		$family			// <str> The creature family.
	,	$name			// <str> The name of the creature.
	,	$prefix = ""	// <str> The prefix of the creature, if applicable.
	)					// RETURNS <int> the Type ID of the creature, or 0 on failure.
...
/****** Return the image source of a creature ******/
	...
	(
		$family			// <str> The family name of the creature.
	,	$name			// <str> The name of the creature.
	,	$prefix = ""	// <str> The prefix of the creature.
	)					// RETURNS <str> the image source (filepath) of the creature.
...
/****** Return whether a pet is noble or exalted ******/
	...
	(
		$prefix = ""	// <str> The prefix of the creature.
	)					// RETURNS <str> the royalty of the pet, without color prefix.
...
/****** Retrieve the pet data of a pet ******/
	...
	(
		$petID			// <int> The ID of the pet to get data on.
	,	$columns = "*"	// <str> The columns to retrieve on the pet.
	)					// RETURNS <str:mixed> the data requested on the pet.
...
/****** Get pet data based on its position in a land plot ******/
	...
	(
		$areaID			// <int> The ID of the area.
	,	$sortVal		// <int> The sort value.
	)					// RETURNS <str:mixed> the data requested on the pet.
...
/****** Retrieve pet type data ******/
	...
	(
		$typeID			// <int> The ID of the pet type to retrieve data from.
	,	$columns = "*"	// <str> The columns to retrieve on the pet type.
	)					// RETURNS <str:mixed> the data requested on the pet type.
...
/****** Determine the activity of the creature, and how busy they are ******/
	...
	(
		$activity		// <str> The type of activity the pet is doing.
	,	$activeUntil	// <int> The date at which the activity will end.
	)					// RETURNS <bool> TRUE if busy, FALSE if not.
...
/****** Feed a pet a number of points ******/
	...
	(
		$petID			// <int> The ID of the pet that you're going to feed.
	,	$points			// <int> The amount of points the pet is being given.
	)					// RETURNS <bool> TRUE on success, or FALSE on failure.
...
/****** Reveal the description after parsing its special markup values ******/
	...
	(
		$desc			// <str> The description prior to parsing the markup.
	,	$nickname		// <str> The nickname of the creature.
	,	$gender			// <str> The gender of the creature.
	)					// RETURNS <str> the new description after parsing the markup.
