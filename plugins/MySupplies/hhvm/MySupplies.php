...
/****** Create the User's Row for the Supply Table ******/
	...
	(
		int $uniID		// <int> The UniID to add to the supplies table.
	): bool				// RETURNS <bool>
...
/****** Get Supplies ******/
	...
	(
		int $uniID			// <int> The Uni-Account to get the supply list from.
	): array <str, mixed>					// RETURNS <str:mixed> the full amount of supplies the user has available.
...
/****** Get Supplies ******/
	...
	(
		int $uniID			// <int> The Uni-Account to get supplies from.
	,	string $supply			// <str> The type of supply to check the value of.
	): int					// RETURNS <int> the amount of those supplies the user has, or 0 on failure.
...
/****** Add or Subtract Supplies ******/
	...
	(
		int $uniID			// <int> The UniID to update supplies to.
	,	string $supply			// <str> The type of supply to add or subtract.
	,	int $amount			// <int> The amount of that supply to add (or subtract, if provide negative values).
	): int					// RETURNS <int> amount of supplies the user has after update, or 0 on error.
...
/****** Set Supplies to an exact amount ******/
	...
	(
		int $uniID			// <int> The UniID to set supplies for.
	,	string $supply			// <str> The type of supply to set.
	,	int $amount			// <int> The amount of that supply to set.
