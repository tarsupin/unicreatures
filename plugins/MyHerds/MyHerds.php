...
/****** Get the list of types from a herd ******/
	...
	(
		$uniID			// <int> The UniID that you're finding pets in.
	,	$family			// <str> The creature family's herd to count the types of.
	,	$population		// <int> The population of the herd.
	)					// RETURNS <int:[str:mixed]> the array of types in the herd.
...
/****** Remove a creature from herd ******/
	...
	(
		$creatureType	// <int> The creature type to remove from the herd.
	,	$creatureNick	// <str> The nickname of the creature to remove.
	)					// RETURNS <bool> TRUE on success, or FALSE on failure.
