...
define("SITE_HANDLE", "unicreatures");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://unicreatures.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "unicreatures.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unicreatures.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "unicreatures.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unicreatures.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "unicreatures.test";
