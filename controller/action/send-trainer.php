...
// Get Pet Data
$pet = MyCreatures::petData((int) $_GET['pet'], "id, uni_id, area_id, type_id, nickname, gender, experience, activity, active_until, total_points");
...
$petType = MyCreatures::petTypeData((int) $pet['type_id'], "family, name, prefix, evolution_level, required_points");
